...
cp PageBattery.qml /opt/victronenergy/gui/qml/
# copy new PageBatteryCellVoltages
cp PageBatteryCellVoltages.qml /opt/victronenergy/gui/qml/
# copy new PageBatteryParameters.qml
cp PageBatteryParameters.qml /opt/victronenergy/gui/qml/
# copy new PageBatterySettings.qml
cp PageBatterySettings.qml /opt/victronenergy/gui/qml/
